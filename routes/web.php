...
Route::view('signIn', 'JobSeeker/signIn');
Route::view('register', 'JobSeeker/register');
Route::post('/register' ,'JobseekerController@register');

Route::post('/signIn' ,'JobseekerController@login');

Route::view('index', 'JobSeeker/index');

Route::view('resume', 'JobSeeker/resume');
Route::post('/resume', 'ResumeController@SaveResume');
Route::get('/viewresume/{$id}', 'ResumeController@viewresume');
